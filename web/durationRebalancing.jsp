...
<div class="col-md-12 col-sm-12">
  <div class="label-name" style="background-color:#fff; box-shadow: 0 5px 5px 1px #ccc;  margin-bottom:20px;padding:0 30px 30px 30px;">
    <h2 class="page-heading">Fill IST Form for Duration Rebalancing </h2>
      <input type="hidden" name="ist_type" id="ist_type" value="Duration Rebalancing">
     ...
     <div class="row form-group">
      <div class="col-md-4 col-sm-4">
       <label class="scheme">Pre trade duration of scheme  (In Years):</label>
         ...
         <div class="col-md-4 col-sm-4 mbtm"><label class="transferor-scheme">Pre trade duration of scheme Transferor(In Years) :</label>
             <input class="form-control input-width" name="transferror_pretrade_duration" id="transferror_pretrade_duration" type="text"  value="" onkeypress="return onlyNumberKey(event)">
      </div>
         <div class="col-md-4 col-sm-4"><label class="transferee-scheme">Pre trade duration of scheme Transferee(In Years) </label>
             <input class="form-control input-width" name="transferee_pretrade_duration" id="transferee_pretrade_duration" type="text" value="" onkeypress="return onlyNumberKey(event)">
      </div>
    </div>
    ...
    <div class="row form-group">
      <div class="col-md-4 col-sm-4">
       <label class="scheme">Post trade duration of scheme (In Years):</label>
         ...
         <div class="col-md-4 col-sm-4 mbtm"><label class="transferor-scheme">Post trade duration of scheme Transferor (In Years):</label>
             <input class="form-control input-width" type="text"  name="transferror_posttrade_duration" id="transferror_posttrade_duration" value="" onkeypress="return onlyNumberKey(event)">
      </div>
         <div class="col-md-4 col-sm-4"><label class="transferee-scheme">Post trade duration of scheme Transferee (In Years) :</label>
             <input class="form-control input-width" name="transferee_posttrade_duration" id="transferee_posttrade_duration" type="text" value="" onkeypress="return onlyNumberKey(event)">
      </div>
    </div>
    
   <div class="row form-group">
      <div class="col-md-4 col-sm-4">
       <label class="scheme">Interest rate view of Fund Manager  :</label>
      </div>
         <div class="col-md-4 col-sm-4 mbtm"><label class="transferor-scheme">Interest rate view of Fund Manager (Transferor):</label>
             <textarea maxlength="1000" class="form-control input-width" rows="4" cols ="50" name="transferror_interestrate_view" id="transferror_interestrate_view"></textarea>
      </div>
         <div class="col-md-4 col-sm-4"><label class="transferee-scheme">Interest rate view of Fund Manager (Transferee)</label>
             <textarea maxlength="1000" class="form-control input-width" rows="4" cols ="50" name="transferee_interestrate_view" id="transferee_interestrate_view" ></textarea>
      </div>
    </div>  
