            ...
            this.show = function () {
                ...
                if (!$this.data('barrating')) {
                    ...
                    if (userOptions.initialRating) {
                        ...
                        initialOption = $('option:selected', $this); //option:selected (this is inside '')
                    }
                    ...
                    if (!userOptions.readonly) {
                        ...
                        $all.on(clickEvent, function (event) {
                            ...
                            if(elementId=="answer_1")$("#errormsg1").html('');
                            if(elementId=="answer_2")$("#errormsg2").html('');                            
                            if(elementId=="answer_4")$("#errormsg4").html('');
                            if(elementId=="answer_7")$("#errormsg7").html('');
                            ...
                            if(elementId=="answer_4" && value=="Strongly Disagree"){
                                $("#errormsg4").html('');
                                $("#othervalue6").val('');
                                $("#textlength3").html('1000');
                                $("#otherdiv3").show();
                            }
                            else if(elementId=="answer_4" && value!="Strongly Disagree"){
                                $("#errormsg4").html('');
                                $("#otherdiv3").hide();
                            }
                            if(elementId=="answer_7")$("#errormsg7").html('');
