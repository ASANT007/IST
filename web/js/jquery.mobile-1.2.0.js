...
/* Event Bindings - hashchange, submit, and click */
	...
	$.mobile.navreadyDeferred.done(function() {
		...
		$( document ).delegate( "form", "", function( event ) {
			var $this = $( this );
...
$.fn.buttonMarkup = function( options ) {
	...
	for ( var i = 0; i < $workingSet.length; i++ ) {
		...
		buttonElements = $.data( ( ( e.tagName === "" || e.tagName === "" ) ? e.parentNode : e ), "" );
...
$.widget( "mobile.checkboxradio", $.mobile.widget, {
	options: {
		theme: null,
		initSelector: "input[type=''],input[type='']"
	},
	_create: function() {
		var self = this,
			input = this.element,
...
$.widget( "mobile.button", $.mobile.widget, {
	options: {
		...
		shadow: true,
		iconshadow: true,
		initSelector: ", [type=''], [type=''], [type='reset']"
	},
	_create: function() {
		var $el = this.element,
			$button,
