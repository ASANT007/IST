<%-- 
    Document   : getISTDetailsByFilter
    Created on : 13 Dec, 2020, 3:37:06 PM
    Author     : amols
--%>
...
<body>
    ...
    <div id="allTranReportResult" class="row" style="margin: 0;">
      <table width="100%" border="0" align="left" cellpadding="0" cellspacing="0" class="table tbl-report">
        <tr> 
            <td width="46" align="left" valign="middle" style="text-align:right; padding:7px;">
             <a href="exportFiterReportsToExcel.jsp?istFromDate=<%=istFrmDate%>&amp;istToDate=<%=istToDate%>&amp;istStatus=<%=istFiterStatus%>&amp;reqISTType=<%=reqISTType%>">
                <img src="images/save-to-excel.gif" alt="Save To Excel" width="32" height="32" border="0" />
             </a>
            </td>
            <td colspan="3" align="left" valign="middle" style="text-align:left; padding:7px 7px 7px 0;" class="link01" >
                <a href="exportFiterReportsToExcel.jsp?istFromDate=<%=istFrmDate%>&amp;istToDate=<%=istToDate%>&amp;istStatus=<%=istFiterStatus%>&amp;reqISTType=<%=reqISTType%>">Generate Report To Excel</a>
            </td>
        </tr>
        <tr>
        ...
        if( filterDataResultSet.next())
        {
           ...
           do{
                ...
                /*if("Recommended".equals(status)){
                    ...
                    pendingUser =  lrmTrans5.getPendingUser(requestId,nextLevel,status,tansferorScheme,transfereeScheme);
