...
function openRepository()
            {
                window.open("viewRepository.jsp", "Repository", "width=1400,height=700,scrollbars=yes,resizable=yes");
            }
...
"f2f2f2",			// Mouse Off Background Color
...
,"&nbsp;&nbsp;&nbsp;Home&nbsp;&nbsp;","adminHomePage.jsp","#","Home",0
,"&nbsp;&nbsp;Master&nbsp;Mgmt&nbsp;&nbsp;","show-menu=sub_master_mgmt","#","Masters",0
...
,"&nbsp;&nbsp;View&nbsp;Client&nbsp;User&nbsp;","viewAllClientUser.jsp","#","View Client User",0
,"&nbsp;&nbsp;KYC&nbsp;Repository&nbsp;","manageRepository.jsp","#","View Repository",0
,"&nbsp;&nbsp;Site&nbsp;Visit&nbsp;Report","viewGuardAttendenceReport.jsp","#","Reports",0
//,"&nbsp;&nbsp;All&nbsp;Reports&nbsp;","filterReportsForAdmin.jsp","#","All Reports",0 // Added by AMOL S. on 11-Mar-2020
,"&nbsp;&nbsp;Reset&nbsp;Password&nbsp;","changePasswordAdmin.jsp","#","Reset Password",0 // Added by AMOL S. on 29-Apr-2020
,"&nbsp;&nbsp;&nbsp;Logout&nbsp;&nbsp;","../logout.jsp","#","Logout",0
...
addmenu(menu=["sub_site_mgmt",
	,,130,1,"",style1,,"left",effect,,,,,,,,,,,,
        ,"Add&nbsp;New&nbsp;Site","addNewSite.jsp",,"Add&nbsp;New&nbsp;Site",0
        ,"View&nbsp;Site","viewSites.jsp",,"View&nbsp;Sites",0
])
